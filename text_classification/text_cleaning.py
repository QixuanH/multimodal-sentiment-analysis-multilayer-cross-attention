...
def main():
    ...
    parser.add_argument('--input_file', type=str, default='/root/autodl-tmp/label.csv', help='The path to the input CSV file')
    parser.add_argument('--output_file', type=str, default='/root/autodl-tmp/label.csv', help='The path to the output CSV file')
