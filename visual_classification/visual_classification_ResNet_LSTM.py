...
class VideoFrameDataset(Dataset):
    def __init__(self, csv_file, root_dir, transform=None):
        ...
        self.processor = AutoImageProcessor.from_pretrained('/root/autodl-tmp/pretrained-model/resnet50/processor')
...
class ViT_LSTM(nn.Module):
    def __init__(self, num_classes, hidden_dim, lstm_layers, bidirectional):
        ...
        self.vit = AutoModel.from_pretrained('/root/autodl-tmp/pretrained-model/resnet50/model')
