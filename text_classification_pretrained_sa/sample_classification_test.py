...
# 假设这是你的样本文本
sample_text = "i feel bad"

tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/twitter-roberta-base-sentiment-latest/tokenizer')
...
class DeBERTaClassifier(nn.Module):
    def __init__(self, ):
        ...
        self.deberta = AutoModel.from_pretrained('/root/autodl-tmp/twitter-roberta-base-sentiment-latest/model')
