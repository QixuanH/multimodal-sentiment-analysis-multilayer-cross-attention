...
from transformers import AutoTokenizer, WhisperProcessor, AutoImageProcessor
...
class Config:
    def __init__(self):
        ...
        self.visual_processor = '/root/autodl-tmp/pretrained-model/facial_emotions_image_detection/processor'
        self.visual_model = '/root/autodl-tmp/pretrained-model/facial_emotions_image_detection/model'
