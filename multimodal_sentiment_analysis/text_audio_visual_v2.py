...
class MultimodalSentimentModel(nn.Module):
    ...
    def forward(self, text_inputs, audio_inputs, visual_inputs):
        ...
        visual_as_query = visual_as_query.unsqueeze(0)
        audio_as_query = audio_as_query.unsqueeze(0)

        # print(combined_features.shape)
        # print(text_features.shape)
        text_as_query = self.cross_attention_avt_query(visual_as_query, text_features, text_features)

        combine_as_query = self.cross_attention_vat_query(audio_as_query, text_features, text_features)
